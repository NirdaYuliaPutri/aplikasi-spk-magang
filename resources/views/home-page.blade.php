...
@section('container')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mt-2">
      <div class="container-fluid container">
        <a class="navbar-brand text-white text-uppercase" href="/">Si Perdi</a>
    ...
    <div class="container bg-danger rounded-3 mt-5">
      <div class="p-5 mb-4 rounded-3 d-flex justify-content-center">
        <div class="container-fluid py-5">
          <a href="/" class="display-4 fw-bold text-white text-decoration-none">Sistem Informasi Perjalanan Dinas</a>
          <p class="text-white h3">Selamat Datang di Sistem Informasi Perjalanan Dinas.</p>
